<head>
    ...
    <meta name="twitter:image" content="{{ asset('assets/img/HIAPh_INC%20LOGO%20HIGHRES-01.png') }}">
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('assets/img/logo_small.png') }}">
    <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('assets/img/logo_large.png') }}">
