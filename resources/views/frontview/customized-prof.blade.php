...
<body>
    ...
    <section class="page-header"><img src="assets/img/PROFESSIONAL-%20HEADER.jpg"></section>
    <section class="page-description">
        <div class="container-fluid">
            <h1 class="text-center" style="line-height: 46px;">customized training programs<br><small>Professionals</small></h1>
            <p class="text-center">Training and development present a prime opportunity to expand an individual’s knowledge and skills. An individual with experience, talent, and proper training becomes an important asset to any organization.&nbsp;</p>
            <p class="text-center">We offer 8-hour training courses to professionals who’d like to improve their skills and learn new skills.&nbsp;<br></p>
        </div>
    </section>
    <section class="customized-training-courses" style="background-image: url(&quot;assets/img/PROFESSIONAL%20-%20TRAINING%20OFFERED.jpg&quot;);background-position: center;background-size: cover;background-repeat: no-repeat;">
        <div class="container-fluid">
            <h1 class="text-center text-lg-left text-xl-left">Training Courses offered:</h1>
            <div class="row">
                <div class="col-12 col-lg-4 col-xl-4">
                    <div class="d-flex flex-column justify-content-center align-items-center customized-training-item"><img src="assets/img/patisserie.png"><span class="text-center">Advanced Pastry</span></div>
                </div>
                <div class="col-12 col-lg-4 col-xl-4">
                    <div class="d-flex flex-column justify-content-center align-items-center customized-training-item"><img src="assets/img/bread%20(1).png"><span class="text-center">Advanced Breads</span></div>
                </div>
                <div class="col-12 col-lg-4 col-xl-4">
                    <div class="d-flex flex-column justify-content-center align-items-center customized-training-item"><img src="assets/img/career-path.png"><span class="text-center">Advanced Personality Development</span></div>
                </div>
                <div class="col-12 col-lg-4 col-xl-4">
                    <div class="d-flex flex-column justify-content-center align-items-center customized-training-item"><img src="assets/img/welcome.png"><span class="text-center">Hospitality Ethics and Personality Development</span></div>
                </div>
                <div class="col-12 col-lg-4 col-xl-4">
                    <div class="d-flex flex-column justify-content-center align-items-center customized-training-item"><img src="assets/img/team-building.png"><span class="text-center">Team Building Program</span></div>
                </div>
                <div class="col-12 col-lg-4 col-xl-4">
                    <div class="d-flex flex-column justify-content-center align-items-center customized-training-item"><img src="assets/img/reviewer.png"><span class="text-center">Advance Customer Care Program</span></div>
                </div>
            </div>
        </div>
    </section>
