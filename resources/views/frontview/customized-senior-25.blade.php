...
<body>
                ...
                <div class="collapse navbar-collapse text-center" id="navcol-1">
                    <ul class="nav navbar-nav mx-auto">
                        ...
                        <li class="nav-item" role="presentation"><a class="nav-link text-center text-lg-center text-xl-center d-none d-sm-none d-md-none d-lg-block d-xl-block" href="#">Online programs</a>
                            <ul class="list-unstyled nav-content">
                                <li><a href="global-e-learning.html">global e-learning</a></li>
    ...
    <section class="page-header"><img src="assets/img/25SH%20-%20HEADER.jpg"></section>
    <section class="page-description">
        <div class="container-fluid">
            <h1 class="text-center" style="line-height: 46px;">customized training programs<br><small>senior high (25 hours)</small></h1>
            <p class="text-center">Training and development is an essential part of the learning of the students. We have various 25-hour courses available for senior high school students.&nbsp;<br></p>
        </div>
    </section>
    <section class="customized-training-courses" style="background-image: url(&quot;assets/img/25SH%20-%20TRAINING%20OFFERED.jpg&quot;);background-position: center;background-size: cover;background-repeat: no-repeat;">
        <div class="container-fluid">
            <h1 class="text-center text-lg-left text-xl-left">Training Courses offered:</h1>
            <div class="row">
                <div class="col-12 col-lg-4 col-xl-4">
                    <div class="d-flex flex-column justify-content-center align-items-center customized-training-item"><img src="assets/img/knife.png"><span class="text-center">Butchery and Fabrication with knife skills</span></div>
                </div>
                <div class="col-12 col-lg-4 col-xl-4">
                    <div class="d-flex flex-column justify-content-center align-items-center customized-training-item"><img src="assets/img/sushi.png"><span class="text-center">Cultures and Cuisine</span></div>
                </div>
                <div class="col-12 col-lg-4 col-xl-4">
                    <div class="d-flex flex-column justify-content-center align-items-center customized-training-item"><img src="assets/img/healthy-food.png"><span class="text-center">Food Design and Photography (Advertising)</span></div>
                </div>
                <div class="col-12 col-lg-4 col-xl-4">
                    <div class="d-flex flex-column justify-content-center align-items-center customized-training-item"><img src="assets/img/cake.png"><span class="text-center">Basic Pastry</span></div>
                </div>
                <div class="col-12 col-lg-4 col-xl-4">
                    <div class="d-flex flex-column justify-content-center align-items-center customized-training-item"><img src="assets/img/bread.png"><span class="text-center">Basic Breads</span></div>
                </div>
                <div class="col-12 col-lg-4 col-xl-4">
                    <div class="d-flex flex-column justify-content-center align-items-center customized-training-item"><img src="assets/img/hotel.png"><span class="text-center">Hotel Operations</span></div>
                </div>
                <div class="col-12 col-lg-4 col-xl-4">
                    <div class="d-flex flex-column justify-content-center align-items-center customized-training-item"><img src="assets/img/bartender.png"><span class="text-center">F &amp; B Operations</span></div>
                </div>
                <div class="col-12 col-lg-4 col-xl-4">
                    <div class="d-flex flex-column justify-content-center align-items-center customized-training-item"><img src="assets/img/tour.png"><span class="text-center">Fundamentals of Tour Guiding</span></div>
                </div>
                <div class="col-12 col-lg-4 col-xl-4">
                    <div class="d-flex flex-column justify-content-center align-items-center customized-training-item"><img src="assets/img/flight-attendant.png"><span class="text-center">The Making of Flight Attendant</span></div>
                </div>
            </div>
        </div>
    </section>
    <section class="customized-training-footer">
        <div class="container-fluid">
            <p class="text-center">As we are committed to helping the clients learn and gain a competitive edge in the global market, these customized training programs we have developed are designed to adapt to the needs of firms from various industries.</p>
        </div>
    </section>
