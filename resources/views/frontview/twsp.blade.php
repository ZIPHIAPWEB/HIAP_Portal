...
theme_color="#031430">
    ...
    <section class="page-header"><img src="assets/img/TWSP%20-%20HEADER%202.jpg">
        <section class="page-description">
            <div class="container-fluid">
                <div>
                    <h1 class="text-center" style="line-height: 46px;">Training for work scholarship program<br><small>Technical education and skills development authority (TESda)</small></h1>
                    <p class="text-center">Training for Work Scholarship Programs (TWSP) is one of TESDA’s scholarship programs to help meet the need for highly critical skills both locally and overseas. This program aims to address the critical skills shortage in priority
                        sectors, particularly in Business Process Outsourcing (BPO), metals and engineering, construction, and tourism. <br></p>
                </div>
            </div>
        </section>
    </section>
    <section class="courses-offered" style="background-image: url(&quot;assets/img/TWSP%20-%20COURSES%20OFFERED.jpg&quot;);background-position: center;background-size: cover;background-repeat: no-repeat;">
        <div class="container-fluid">
            <h1>courses offered:</h1>
            <div class="row no-gutters row-cols-1 row-cols-lg-5 row-cols-xl-5 justify-content-center">
                <div class="col">
                    <div class="d-flex justify-content-center align-items-end course-item" style="background-image: url(&quot;assets/img/TWSP%20-%20BPP.jpg&quot;);background-position: center;background-size: cover;background-repeat: no-repeat;" data-toggle="modal"
                        data-target="#bpp-modal">
                        <div class="course-name"><span>Bread and pastry production<br>nc ii</span></div>
                    </div>
                </div>
                <div class="col">
                    <div class="d-flex justify-content-center align-items-end course-item" style="background-image: url(&quot;assets/img/TWSP%20-%20HOUSEKEEPING.jpg&quot;);background-position: center;background-size: cover;background-repeat: no-repeat;" data-toggle="modal"
                        data-target="#hkp-modal">
                        <div class="course-name"><span>Housekeeping<br>nc II<br></span></div>
                    </div>
                </div>
                <div class="col">
                    <div class="d-flex justify-content-center align-items-end course-item" style="background-image: url(&quot;assets/img/TWSP%20-%20COOKERY.jpg&quot;);background-position: center;background-size: cover;background-repeat: no-repeat;" data-toggle="modal"
    ...
    <section class="course-qualifications" style="background-image: url(&quot;assets/img/TWSP%20-%20QUALIFICATION.jpg&quot;);background-position: center;background-size: cover;background-repeat: no-repeat;">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col">
                    <div class="d-flex flex-column justify-content-center align-items-center qualification-item"><img src="assets/img/fun.png"><span class="text-center">Must be at least 18 years old</span></div>
                </div>
                <div class="col">
                    <div class="d-flex flex-column justify-content-center align-items-center qualification-item"><img src="assets/img/graduation.png"><span class="text-center">At least high school graduate</span></div>
                </div>
            </div>
        </div>
    </section>
    ...
    </div><a id="go-back-button" href="#"><i class="fa fa-angle-up"></i></a>
