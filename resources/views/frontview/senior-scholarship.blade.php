...
<body>
                    ...
                    <ul
                        ...
                        <li class="nav-item" role="presentation"><a class="nav-link text-center text-lg-center text-xl-center d-none d-sm-none d-md-none d-lg-block d-xl-block" href="#">learn more</a>
                            <ul class="list-unstyled nav-content">
                                ...
                                <li><a href="social-stream.html">social streams</a></li>
                            </ul>
                        </li>
    ...
    <section class="page-header"><img src="assets/img/SHS%20-%20HEADER%202.jpg"></section>
    <section class="page-description">
        <div class="container-fluid">
            <div>
                <h1 class="text-center">Senior high scholarship program</h1>
                <p class="text-center">The success of many businesses depends heavily on the quality of their service. Undeniably, the global demands of different industries are increasing every year, and the expectations for quality service is becoming exceedingly high. These
                    demands are no longer limited to the degree holders and professionals but are now also for skilled-workers. However, these opportunities require specialized skills and training.&nbsp;</p>
                <p class="text-center">Hospitality Institute of America-Philippines Inc. (HIAP Inc.) offers training and assessment programs to senior high students, college students, and professionals to help them acquire a competitive edge in the global market.<br></p>
            </div>
        </div>
    </section>
    <section class="courses-offered" style="background-image: url(&quot;assets/img/SHS%20-%20COURSES%20OFFERED.jpg&quot;);background-position: center;background-size: cover;background-repeat: no-repeat;">
        <div class="container-fluid">
            <h1>courses offered:</h1>
            <div class="row no-gutters row-cols-1 row-cols-lg-5 row-cols-xl-5 justify-content-center">
                <div class="col">
                    <div class="d-flex justify-content-center align-items-end course-item" style="background-image: url(&quot;assets/img/SCHOLAR%20-%20%20BPP.jpg&quot;);background-position: center;background-size: cover;background-repeat: no-repeat;" data-toggle="modal"
                        data-target="#bpp-modal">
                        <div class="course-name"><span>Bread and pastry production<br>nc ii</span></div>
                    </div>
                </div>
                <div class="col">
                    <div class="d-flex justify-content-center align-items-end course-item" style="background-image: url(&quot;assets/img/SCHOLAR%20-%20%20HOUSEKEEPING.jpg&quot;);background-position: center;background-size: cover;background-repeat: no-repeat;" data-toggle="modal"
                        data-target="#hkp-modal">
                        <div class="course-name"><span>Housekeeping<br>nc II<br></span></div>
                    </div>
                </div>
                <div class="col">
                    <div class="d-flex justify-content-center align-items-end course-item" style="background-image: url(&quot;assets/img/SCHOLAR%20-%20%20COOKERY.jpg&quot;);background-position: center;background-size: cover;background-repeat: no-repeat;" data-toggle="modal"
                        data-target="#ck-modal">
                        <div class="course-name"><span>Cookery<br>nc ii</span></div>
                    </div>
                </div>
                <div class="col">
                    <div class="d-flex justify-content-center align-items-end course-item" style="background-image: url(&quot;assets/img/SCHOLAR%20-%20%20F&B.jpg&quot;);background-position: center;background-size: cover;background-repeat: no-repeat;" data-toggle="modal"
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12 col-lg-4 col-xl-4">
                    <div class="d-flex flex-column justify-content-center align-items-center justify-content-xl-center align-items-xl-center requirement-item"><img src="assets/img/File.png"><span class="text-center">PSA Birth Certificate<br><small>(Original &amp; Photocopy)</small></span></div>
                </div>
                <div class="col-12 col-lg-4 col-xl-4">
                    <div class="d-flex flex-column justify-content-center align-items-center justify-content-xl-center align-items-xl-center requirement-item"><img src="assets/img/id.png"><span class="text-center">Two valid ID's<br><small>(Original &amp; Photocopy)</small></span></div>
                </div>
                <div class="col-12 col-lg-4 col-xl-4">
                    <div class="d-flex flex-column justify-content-center align-items-center justify-content-xl-center align-items-xl-center requirement-item"><img src="assets/img/Portrait.png"><span class="text-center">Passport Picture<br><small>(White Background /<br>With Collar and Nametag)</small></span></div>
                </div>
            </div>
        </div>
    </section>
