...
<body>
                            ...
                            <ul class="list-unstyled nav-content">
                                ...
                                <li><a href="#">scholarship Programs</a>
                                    <ul class="list-unstyled">
                                        ...
                                        <li><a href="/owwa.hl">sesp - owwa programs</a></li>
    ...
    <section class="page-header"><img src="assets/img/ASSESSMENT%20-%20HEADER%202.jpg"></section>
    <section class="page-description">
        <div class="container-fluid">
            <div>
                <h1 class="text-center">tesda Assessment programs</h1>
                <p class="text-center">We have aligned our services to the workplace-based standards set by TESDA. TESDA pursues the assessment and certification of graduates or middle-skilled level workers. The assessment process seeks to determine whether the assessee can
                    perform to the workplace-based competency standards. We also provide assessment services to individual clients equipped with proper training and industry experience.&nbsp;<br></p>
            </div>
        </div>
    </section>
    <section class="courses-offered" style="background-image: url(&quot;assets/img/ASSESSMENT%20-%20COURSES%20OFFERED.jpg&quot;);background-position: center;background-size: cover;background-repeat: no-repeat;">
        <div class="container-fluid">
            <h1 class="text-center text-lg-left text-xl-left">courses offered:</h1>
            <div class="row no-gutters row-cols-1 row-cols-xl-5 justify-content-center">
                <div class="col">
                    <div class="d-flex justify-content-center align-items-end course-item" style="background-image: url(&quot;assets/img/ASSESSMENT%20-BPP.jpg&quot;);background-position: center;background-size: cover;background-repeat: no-repeat;" data-toggle="modal" data-target="#bpp-modal">
                        <div class="course-name"><span>Bread and pastry production<br>nc ii</span></div>
                    </div>
                </div>
                <div class="col">
                    <div class="d-flex justify-content-center align-items-end course-item" style="background-image: url(&quot;assets/img/ASSESSMENT%20-HOUSEKEEPING.jpg&quot;);background-position: center;background-size: cover;background-repeat: no-repeat;" data-toggle="modal" data-target="#hkp-modal">
                        <div class="course-name"><span>Housekeeping<br>nc II<br></span></div>
                    </div>
                </div>
                <div class="col">
                    <div class="d-flex justify-content-center align-items-end course-item" style="background-image: url(&quot;assets/img/ASSESSMENT%20-COOKERY.jpg&quot;);background-position: center;background-size: cover;background-repeat: no-repeat;" data-toggle="modal" data-target="#ck-modal">
                        <div class="course-name"><span>Cookery<br>nc ii</span></div>
                    </div>
                </div>
                <div class="col">
                    <div class="d-flex justify-content-center align-items-end course-item" style="background-image: url(&quot;assets/img/ASSESSMENT%20-F&B.jpg&quot;);background-position: center;background-size: cover;background-repeat: no-repeat;" data-toggle="modal" data-target="#fnb-modal">
                        <div class="course-name"><span>food and beverage services<br>nc ii<br></span></div>
                    </div>
                </div>
                <div class="col">
                    <div class="d-flex justify-content-center align-items-end course-item" style="background-image: url(&quot;assets/img/ASSESSMENT%20-BARTENDING.jpg&quot;);background-position: center;background-size: cover;background-repeat: no-repeat;" data-toggle="modal" data-target="#bt-modal">
                        <div class="course-name"><span>bartending <br>nc ii<br></span></div>
                    </div>
                </div>
            </div>
        </div>
