...
<body>
            ...
            <button
                ...
                <div class="collapse navbar-collapse text-center" id="navcol-1">
                    ...
                    <ul
                        ...
                        <li class="nav-item" role="presentation"><a class="nav-link" href="/enroll-now" style="background: #961a32;color: white !important;border-radius: 10px;">Login</a></li>
                        </ul>
                </div>
        </div>
    </nav>
    <section class="d-flex flex-column justify-content-center align-items-center elearning" style="background-image: url(&quot;assets/img/BLOG%20-%20HEADER.jpg&quot;);">
        <div class="container text-center d-xl-flex flex-column justify-content-xl-center align-items-xl-center">
            <h1 class="text-center">streamlined application processing.</h1>
            <h2 class="text-center mb-3">study and excel with us.</h2>
            <h4 class="text-center">Online Application will be available soon.</h4>
        </div>
    </section>
