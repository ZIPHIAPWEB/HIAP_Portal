...
<body>
    ...
    <section class="page-header"><img src="assets/img/WSH%20-%20HEADER.jpg"></section>
    <section class="page-description">
        <div class="container-fluid">
            <h1 class="text-center" style="line-height: 46px;">customized training programs<br><small>senior high (whole day)</small></h1>
            <p class="text-center">As we are committed to helping our clients develop their skills and prepare themselves for the future, we also have 8-hour courses available for students who’d like to undergo training.&nbsp;<br></p>
        </div>
    </section>
    <section class="customized-training-courses" style="background-image: url(&quot;assets/img/WSH-%20TRAINING%20OFFERED.jpg&quot;);background-position: center;background-size: cover;background-repeat: no-repeat;">
        <div class="container-fluid">
            <h1 class="text-center text-lg-left text-xl-left">Training Courses offered:</h1>
            <div class="row">
                <div class="col-12 col-lg-4 col-xl-4">
                    <div class="d-flex flex-column justify-content-center align-items-center customized-training-item"><img src="assets/img/dashboard.png"><span class="text-center">Introduction to Research Writing</span></div>
                </div>
                <div class="col-12 col-lg-4 col-xl-4">
                    <div class="d-flex flex-column justify-content-center align-items-center customized-training-item"><img src="assets/img/chocolate.png"><span class="text-center">Chocolate &amp; Confectionery Technology and Techniques</span></div>
                </div>
                <div class="col-12 col-lg-4 col-xl-4">
                    <div class="d-flex flex-column justify-content-center align-items-center customized-training-item"><img src="assets/img/resort.png"><span class="text-center">Introduction to Park and Resorts</span></div>
                </div>
                <div class="col-12 col-lg-3 col-xl-3">
                    <div class="d-flex flex-column justify-content-center align-items-center customized-training-item"><img src="assets/img/airplane.png"><span class="text-center">Art of Selling for Travel Services</span></div>
                </div>
                <div class="col-12 col-lg-3 col-xl-3">
                    <div class="d-flex flex-column justify-content-center align-items-center customized-training-item"><img src="assets/img/luggage.png"><span class="text-center">Foundations in Travel Agency Operations</span></div>
                </div>
                <div class="col-12 col-lg-3 col-xl-3">
                    <div class="d-flex flex-column justify-content-center align-items-center customized-training-item"><img src="assets/img/boat.png"><span class="text-center">Introductions to Cruise Industry</span></div>
                </div>
                <div class="col-12 col-lg-3 col-xl-3">
                    <div class="d-flex flex-column justify-content-center align-items-center customized-training-item"><img src="assets/img/speech-bubble.png"><span class="text-center">Effective Conversational English</span></div>
                </div>
            </div>
        </div>
    </section>
