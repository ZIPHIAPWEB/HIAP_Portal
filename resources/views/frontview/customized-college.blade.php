...
<body>
    ...
    <section class="page-header"><img src="assets/img/COLLEGE%20-%20HEADER.jpg"></section>
    <section class="page-description">
        <div class="container-fluid">
            <h1 class="text-center" style="line-height: 46px;">customized training programs<br><small>college (Whole Day)</small></h1>
            <p class="text-center">Students need to prepare to enter the workforce. They must develop other critical skills needed to become an effective individual once they graduate.&nbsp;<br></p>
        </div>
    </section>
    <section class="customized-training-courses" style="background-image: url(&quot;assets/img/COLLEGE%20-%20TRAINING%20OFFERED.jpg&quot;);">
        <div class="container-fluid">
            <h1 class="text-center text-lg-left text-xl-left">Training Courses offered:</h1>
            <div class="row">
                <div class="col-12 col-lg-4 col-xl-4">
                    <div class="d-flex flex-column justify-content-center align-items-center customized-training-item"><img src="assets/img/museum.png"><span class="text-center">Seminar on Heritage and Cultural Tourism</span></div>
                </div>
                <div class="col-12 col-lg-4 col-xl-4">
                    <div class="d-flex flex-column justify-content-center align-items-center customized-training-item"><img src="assets/img/snorkel.png"><span class="text-center">Seminar on Scuba Diving and Marine Tourism</span></div>
                </div>
                <div class="col-12 col-lg-4 col-xl-4">
                    <div class="d-flex flex-column justify-content-center align-items-center customized-training-item"><img src="assets/img/gallery.png"><span class="text-center">VIsitor Management</span></div>
                </div>
                <div class="col-12 col-lg-4 col-xl-4">
                    <div class="d-flex flex-column justify-content-center align-items-center customized-training-item"><img src="assets/img/wheelchair.png"><span class="text-center">Assisting Travelers with Disabilities</span></div>
                </div>
                <div class="col-12 col-lg-4 col-xl-4">
                    <div class="d-flex flex-column justify-content-center align-items-center customized-training-item"><img src="assets/img/kitchen.png"><span class="text-center">Kitchen and Restaurant Design</span></div>
                </div>
                <div class="col-12 col-lg-4 col-xl-4">
                    <div class="d-flex flex-column justify-content-center align-items-center customized-training-item"><img src="assets/img/index.png"><span class="text-center">Hospitality Accounting and Cost Control</span></div>
                </div>
                <div class="col-12 col-lg-4 col-xl-4">
                    <div class="d-flex flex-column justify-content-center align-items-center customized-training-item"><img src="assets/img/wine.png"><span class="text-center">Bartending with Wine Appreciation</span></div>
                </div>
                <div class="col-12 col-lg-4 col-xl-4">
                    <div class="d-flex flex-column justify-content-center align-items-center customized-training-item"><img src="assets/img/leadership.png"><span class="text-center">Leadership Training in the Airline, Travel Events Industries</span></div>
                </div>
                <div class="col-12 col-lg-4 col-xl-4">
                    <div class="d-flex flex-column justify-content-center align-items-center customized-training-item"><img src="assets/img/conversation.png"><span class="text-center">Effective Business Communication</span></div>
                </div>
            </div>
        </div>
    </section>
